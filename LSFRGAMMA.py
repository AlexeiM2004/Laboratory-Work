# -*- coding: utf-8 -*-
"""
Created on Tue Feb 25 11:02:33 2025
...
FILE_NAME = 'LSFRPULSEDATA2.txt'  # Remember to include the extension
SKIP_FIRST_LINE = False
DELIMITER = ','  # Set to space, ' ', if working with .txt file without commas

# Plotting details
PLOT_TITLE = 'Linear fit plot of Characteristic Distance vs Gamma Ray energy for Lead'

X_LABEL = 'Gamma Ray Energy [keV]'
Y_LABEL = 'Characteristic Distance, [m]'
AUTO_X_LIMITS = True
